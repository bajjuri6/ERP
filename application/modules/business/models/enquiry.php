...
class Viven_Model_Enquiry extends Model{
  ...
  function addEnquiry($data){
    $timeCreated = time();
    $query = "INSERT INTO `viv_inq_en` (`_inq_emp_un`, `_inq_branch`, `_inq_cus_name`, `_inq_cus_pnum`,
              `_inq_cus_email`, `_inq_time`, `_inq_ref`, `_inq_type`, `_inq_cmnts`, `_inq_ref_cmnts`, `_inq_status`, `_inq_addedby`, 
              `_inq_addedon`, `_inq_lastmodby`, `_inq_lastmodon`) 
