...
CREATE TABLE IF NOT EXISTS `viv_emp_emer_en` (
  ...
  `_emp_emer_email` varchar(40) DEFAULT NULL,
...
INSERT INTO `viv_emp_emer_en` (`_emp_emer_id`, `_emp_emer_un`, `_emp_emer_name`, `_emp_emer_email`, `_emp_emer_phone`, `_emp_emer_address`, `_emp_emer_remarks`, `_emp_emer_status`, `_emp_emer_addedby`, `_emp_emer_addedon`, `_emp_emer_lastmodby`, `_emp_emer_lastmodon`) VALUES
(1, 'bajjuri6', 'bvr', 'asjdk', '', 'asd', 'saf', 1, 'bajjuri6', 1377185421, 'bajjuri6', 1377185421);
...
(2, 'Sandeep Reddy', 'Nagole', 'sandyreddy', 1, 'bajjuri6', 1376658570),
(3, 'Venugopal Rao', 'Nagole', 'VIM004', 1, 'bajjuri6', 1377684003);
...
CREATE TABLE IF NOT EXISTS `viv_emp_pro_en` (
  ...
  `_emp_pro_shift` varchar(10) NOT NULL,
  `_emp_pro_type` varchar(10) NOT NULL,
...
(1, 'bajjuri6', '127.0.0.1', '/', 1376594347),
(2, 'bajjuri6', '127.0.0.1', '/', 1376657239),
(3, 'bajjuri6', '127.0.0.1', '/', 1376717810),
(4, 'bajjuri6', '127.0.0.1', '/', 1376745334),
(5, 'bajjuri6', '127.0.0.1', '/', 1376996662),
(6, 'bajjuri6', '127.0.0.1', '/', 1376996690),
(7, 'bajjuri6', '127.0.0.1', '/', 1376996739),
(8, 'bajjuri6', '127.0.0.1', '/', 1376997143),
(9, 'bajjuri6', '127.0.0.1', '/', 1377182059),
(10, 'bajjuri6', '127.0.0.1', '/', 1377509518),
(11, 'bajjuri6', '127.0.0.1', '/', 1377683874);
